...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/employer/button.css">
</head>
<style>
h1 {
	text-align: center;
...
<%
	...
	<div class="container">
	    ...
	    <form action="/sem5_job_portal/admin/search_job" method="POST" class="search-bar">
	    	<input type="hidden" name="employerId" value='<%= request.getParameter("employerId")%>'>
